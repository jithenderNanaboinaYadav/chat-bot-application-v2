    ...
    <div className="h-screen bg-gradient-to-r from-indigo-500 dark:bg-red-500">
      <div className="container mx-auto flex items-center justify-center">
        <div className="mx-auto justify-center text-center">
          ...
          <hr/>
          <h1 className="font-semibold text-5xl text-sky-700 uppercase mb-4 mt-2">One Page Template</h1><hr/>
          <p className="mt-2 mb-2">"Lorem Ipsum is simply dummy text of the printing and typesetting industry"</p>
         <button className="mb-2 p-4 bg-sky-900 font-semibold uppercase text-base text-yellow-500">Contact Now</button>
